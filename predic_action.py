...
models = load_ensemble_models(model_path_template='../WD_RL_Control' + '/best_model_ensemble_{}.pth')

# Load the scalers
scaler_x = load('scaler_x_test.joblib')
scaler_y = load('scaler_y_test.joblib')
